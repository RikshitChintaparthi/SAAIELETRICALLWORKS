...
export async function POST(req: NextRequest) {
  try {
    ...
    const projects: Project[] = [
      {
        ...
        description: "Complete Electrical Infrastructure - 11KV Substation & Clean Room Power. Progress: 75%. Expected: March 2025",
        cover_image: "",
        process_steps: [],
        status: "in-progress",
      ...
      },
      {
        ...
        description: "Smart Building Electrical Systems - 33KV Distribution & Automation. Progress: 60%. Expected: April 2025",
        cover_image: "",
        process_steps: [],
        status: "in-progress",
        related_services: ["service-2", "service-5"],
      ...
      },
      {
        ...
        description: "Industrial Power Distribution - LT Panels & Process Control. Progress: 40%. Expected: June 2025",
        cover_image: "",
        process_steps: [],
        status: "in-progress",
      ...
      },
      {
        ...
        description: "Solar Plant Electrification - 5MW Solar Installation. Progress: 85%. Expected: February 2025",
        cover_image: "",
        process_steps: [],
        status: "in-progress",
      ...
      },
      {
        ...
        description: "Complete HT & LT Electrical Installation - 33KV Substation & Power Distribution. Completed 2023",
        cover_image: "",
        process_steps: [],
        status: "completed",
      ...
      },
      {
        ...
        description: "Electrical Infrastructure & Automation - 11KV Distribution & Control Systems. Completed 2023",
        cover_image: "",
        process_steps: [],
        status: "completed",
        related_services: ["service-2", "service-5"],
      ...
      },
      {
        ...
        description: "Hospital Electrical Systems & Emergency Power - LT Panels, DG Sets & UPS Systems. Completed 2022",
        cover_image: "",
        process_steps: [],
        status: "completed",
    ...
    return NextResponse.json({ success: true, message: "Data populated successfully" });
  } catch (error) {
